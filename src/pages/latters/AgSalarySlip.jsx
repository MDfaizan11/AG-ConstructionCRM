...
//       month: formatMonthYear(data.monthYear).split(" ")[0], // Extract month name
//       year: parseInt(data.monthYear.split("-")[0]), // Extract year
...
//       console.log("Salary slip saved:", result);
...
//       });
//     } catch (error) {
//       console.error("Failed to submit salary slip:", error);
//       alert("Failed to submit salary slip. Please try again.");
//     }
//   };

//   // Calculate totals
//   const calculateTotalAddition = (data) => {
//     return data ? data.basic + data.hra + data.bonus + data.allowance : 0;
//   };
...
//     return data
//       ? calculateTotalAddition(data) - calculateTotalDeductions(data)
//       : 0;
//   };
...
//     const opt = {
//       margin: 0.5,
//       filename: `AG_Construction_Salary_Slip_${formData.employeeId}_${formData.monthYear}.pdf`,
...
//           <h2 className="AgSalarySlip-title">
//             AG Construction Salary Slip Form
//           </h2>
...
//                       </button>
//                       <button
//                         className="AgSalarySlip-action-button edit"
...
//         {/* Salary Slip Display */}
//         {submittedData && (
//           <div className="AgSalarySlip-slip-container" ref={slipRef}>
...
//                 Month: {formatMonthYear(submittedData.monthYear)}
//               </p>
//             </div>
