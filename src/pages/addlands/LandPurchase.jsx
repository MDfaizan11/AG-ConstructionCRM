                ...
                {currentItems.map((land, index) => (
                  <tr key={index}>
                    ...
                    <td className="mixed_button_add_land">
                      ...
                      {/* <button className="land_show_start_button"> Start</button> */}
                    </td>
                  </tr>
                ))}
              </tbody>
                ...
                {showCard.map((item, index) => (
                  <tr key={item.id}>
                    ...
                    <td>
                      ...
                      <button
                        className="patner_table_view_button"
                        onClick={() => handleNewpaynemt(item.id)}
                      >
                        {" "}
                        Add Payment
                      </button>
      ...
      {showAddpatnerForm && (
        <>
          ...
          >
            ...
            <input
              type="text"
              placeholder="Enter patner Phone Number"
              className="add_patner_form_input"
